<template>
  <div class="lead mb-0 mt-5 bg-light text-dark border p-4 rounded-xl">
    <h3>How it works:</h3>
    This is a Twitter bot. Share your idea as a comment on the <a :href="'https://twitter.com/magicstoryfrog/status/' + latestTweet">most recent tweet</a>. Every day at midnight (UTC) the comment with the most likes will be appended to the story and a new tweet will be posted. That means: Be early and be creative!<br>
    <br>
    ...
    <div class="border rounded-xl py-3 px-5 mt-2 mb-3 bg-white">
      After defeating the gigantic dwarf king, they had to rest for a while.<br>
      <br>
